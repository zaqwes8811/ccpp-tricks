/// "Easy reason about." Если в цикле много условий то не слишком ли он много на
/// себя берет?
//
// http://channel9.msdn.com/Events/GoingNative/2013/Cpp-Seasoning
//

// Raw loop - A raw loop is any loop inside function where the function serve
// purpose larger then tha algorithm implemented by the loop.
//
// Why no raw loops?
...
// - Implement a know algorithm as a general function (contribute to library -
// внутреннюю или открытую
//   сперва нужно сделать как можно конкретнее, поюзать и понять где можно
//   генереализовать)
...
// http://stackoverflow.com/questions/13286876/boostrange-iterator-and-boostiterator-range-confusion
// - есть еще
...
void PanelBar::RepositionExpandedPanels(Panel* fixed_panel) {
  ...
  for (size_t i = 0; i < expanded_panels_.size(); ++i) {
    ...
    //
    if (center_x <= panel->cur_panel_center() || i == expanded_panel_.size() -
1) {
