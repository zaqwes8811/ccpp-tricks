...
// Case 1:
For example, if this is our template, template <typename T> void f(T &param);
...
f(rx); // T is const int,  // That’s because rx’s reference-ness is ignored
...
// This rarely makes any difference in practice, but if you’re going to know
// about array- to-pointer decay, you might as well know about
// function-to-pointer decay, too.
...
// template, and the type specifier for the variable acts as ParamType.
