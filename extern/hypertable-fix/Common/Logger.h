...
#define HT_ERROR(msg) HT_LOG(Logger::Priority::_ERROR, msg)
#define HT_ERRORF(msg, ...) HT_LOGF(Logger::Priority::_ERROR, msg, __VA_ARGS__)
#define HT_ERROR_OUT HT_OUT2(Logger::Priority::_ERROR)
#else
#define HT_ERROR(msg)
