...
TEST(M, Main) {
    // 54 - срезка
    // Похоже тут дело даже не в этом. А в том, что если мы переопределям конструторы копирования
    // при наследновании возникает много трудностей. Но работа с кучей!
