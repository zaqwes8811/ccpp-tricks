...
int m(int argc) { return global_array[argc + 100]; }
...
TEST(ASanTest, Banch) {
  ...
  // int i = global_array[j+100];  // no protection after some shift +160
  // example int i = val(j);  // no protection after some shift +160 example
  // return i;
