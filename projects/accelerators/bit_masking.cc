...
WholeData2LayerDeep::WholeData2LayerDeep() { vector<DataLeafNode<int>>(sz * sz * sz).swap(leafs); }
...
int main() {
    // "OpenVDB: An Open Source Data Structure and Toolkit for High-Resolution
    // Volumes"
    //
    // caches
