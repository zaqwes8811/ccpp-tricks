...
template class flex_string<char, std::char_traits<char>, std::allocator<char>,
                           AllocatorStringStorage<char, std::allocator<char>>>;
...
template <class String, class Integral> void Num2String(String &str, Integral) {
  str.resize(10, '\0');
  ...
  while (count--) {
    ...
    case 1:
      // test copy constructor 21.3.1
      {
        ...
        String s(test, pos,
                 random(0, static_cast<typename String::size_type>(test.size() -
                                                                   pos)));
        test = s;
      }
      break;
    ...
    case 14:
      // exercise empty
      {
        ...
        if (test.empty())
          test = String(kEmptyString, kEmptyString + strlen(kEmptyString));
        else
          test = String(kNonEmptyString,
                        kNonEmptyString + strlen(kNonEmptyString));
      }
      break;
    case 15:
    ...
    case 35:
      ...
      {
        String str = RandomString(&test, maxString);
        test.insert(random(0, test.size()), str, random(0, str.size()),
                    random(0, maxString));
      }
      break;
    case 36:
      ...
      {
        String str = RandomString(&test, maxString);
        test.insert(random(0, test.size()), str.c_str(), random(0, str.size()));
      }
      break;
    case 37:
      // 21.3.5 modifiers
    ...
    case 38:
      // 21.3.5 modifiers
      test.insert(random(0, test.size()), random(0, maxString),
                  random('a', 'z'));
      break;
    case 39:
      // 21.3.5 modifiers
      test.insert(test.begin() + random(0, test.size()), random('a', 'z'));
      break;
    case 40:
      // 21.3.5 modifiers
      {
        std::list<char> lst(RandomList(maxString));
        test.insert(test.begin() + random(0, test.size()), lst.begin(),
                    lst.end());
      }
      break;
    case 41:
    ...
    case 43:
      // 21.3.5 modifiers
      {
        const typename String::iterator i =
            test.begin() + random(0, test.size());
    ...
    case 46:
      // 21.3.5 modifiers
      {
        ...
        if (avoidAliasing) {
          test.replace(pos1, pos1 + random(0, test.size() - pos1), String(test),
    ...
    case 48:
      // 21.3.5 modifiers
      {
        ...
        if (avoidAliasing) {
          ...
          test.replace(pos, random(0, test.size() - pos), test.c_str(),
                       test.size());
        }
      }
      break;
    ...
    case 56:
      // 21.3.5 modifiers
      {
        ...
        test.copy(&vec[0], vec.size(), random(0, test.size()));
      }
      break;
    case 57:
      // 21.3.5 modifiers
    ...
    case 59:
      ...
      {
        String str =
            test.substr(random(0, test.size()), random(0, test.size()));
    ...
    case 69:
      // 21.3.6 string operations
      {
        String str = RandomString(&test, maxString);
        Num2String(test,
                   test.find_first_of(str.c_str(), random(0, test.size())));
      }
      break;
    case 70:
      // 21.3.6 string operations
    ...
    case 73:
      // 21.3.6 string operations
      {
        String str = RandomString(&test, maxString);
        Num2String(test,
                   test.find_last_of(str.c_str(), random(0, test.size())));
      }
      break;
    case 74:
      // 21.3.6 string operations
      Num2String(test,
                 test.find_last_of(random('a', 'z'), random(0, test.size())));
      break;
    case 75:
      // 21.3.6 string operations
      {
    ...
    case 76:
      // 21.3.6 string operations
      {
        String str = RandomString(&test, maxString);
        Num2String(test,
                   test.find_first_not_of(str.c_str(), random(0, test.size()),
                                          random(0, str.size())));
      }
      break;
    case 77:
    ...
    case 78:
      // 21.3.6 string operations
      Num2String(test, test.find_first_not_of(random('a', 'z'),
                                              random(0, test.size())));
      break;
    case 79:
      // 21.3.6 string operations
    ...
    case 80:
      // 21.3.6 string operations
      {
        String str = RandomString(&test, maxString);
        Num2String(test,
                   test.find_last_not_of(str.c_str(), random(0, test.size()),
                                         random(0, str.size())));
      }
      break;
    case 81:
    ...
    case 82:
      // 21.3.6 string operations
      Num2String(test, test.find_last_not_of(random('a', 'z'),
                                             random(0, test.size())));
      break;
    case 83:
      // 21.3.6 string operations
    ...
    case 85: {
      int tristate =
          test.compare(random(0, test.size()), random(0, test.size()),
                       RandomString(&test, maxString));
      if (tristate > 0)
        tristate = 1;
      else if (tristate < 0)
    ...
    case 87: {
      int tristate = test.compare(RandomString(&test, maxString).c_str());
      if (tristate > 0)
        tristate = 1;
      else if (tristate < 0)
        tristate = 2;
    ...
    case 89:
      test = RandomString(&test, maxString) + RandomString(&test, maxString);
      break;
    case 90:
      test = RandomString(&test, maxString).c_str() +
             RandomString(&test, maxString);
...
void Compare() {
  ...
  for (;;) {
    ...
    {
      srand(t);
      typedef VectorStringStorage<char, std::allocator<char>> Storage;
      typedef flex_string<char, std::char_traits<char>, std::allocator<char>,
    ...
    {
      srand(t);
      typedef SimpleStringStorage<char, std::allocator<char>> Storage;
      typedef flex_string<char, std::char_traits<char>, std::allocator<char>,
    ...
    {
      srand(t);
      typedef AllocatorStringStorage<char, std::allocator<char>> Storage;
      typedef flex_string<char, std::char_traits<char>, std::allocator<char>,
                          CowStringOpt<Storage>>
          my_string;
      static my_string sample;
    ...
    /*
            {    // SimpleStringStorage with UTF16 Encoding
                ...
                const my_string tested(Test(sample, 1, false));
                assert(tested.size() == reference.size());
                //assert(std::string(tested.data(), tested.size()) ==
       reference);
           }
           */
  }
...
/// This function tests out a bug found by Jean-Francois Bastien in the find
/// function.
void TestBug2536490(void) {

  my_string bug;
  std::cout << "Index of '6' in \"" << bug.c_str() << "\": " << bug.find('6')
            << std::endl;
  bug = "12345";
  std::cout << "Index of '6' in \"" << bug.c_str() << "\": " << bug.find('6')
            << std::endl;
  ...
  bug = "12345";
  std::cout << "Index of '123' in \"" << bug.c_str()
            << "\": " << bug.find("123") << std::endl;
  bug = "12345";
  std::cout << "Index of '12345' in \"" << bug.c_str()
            << "\": " << bug.find("12345") << std::endl;
  bug = "12345";
  std::cout << "Index of '345' in \"" << bug.c_str()
            << "\": " << bug.find("345") << std::endl;
  bug = "123456";
  std::cout << "Index of '456' in \"" << bug.c_str()
            << "\": " << bug.find("456") << std::endl;
  bug = "12345";
  std::cout << "Index of '456' in \"" << bug.c_str()
            << "\": " << bug.find("456") << std::endl;
}
