...
void DoInheritanceConversionTests(void) {
  ...
  //  p2 = p1;  // illegal!  Can't do cast to derived class in pointer
  //  assignment. p2 = p3;  // illegal!  Can't assign when types are unrelated.
  //  p3 = p1;  // illegal!  Can't do cast to derived class in pointer
  //  assignment. p3 = p2;  // illegal!  Can't assign when types are unrelated.
