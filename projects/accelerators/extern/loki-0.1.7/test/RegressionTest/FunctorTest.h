...
void free_function(bool &result) { result = true; }
...
public:
  ...
  virtual void execute(TestResult &result) {
    ...
    Functor<void, LOKI_TYPELIST_1(bool &)> classFunctor(&testClass,
                                                        &TestClass::member);
    Functor<void, LOKI_TYPELIST_1(bool &)> classFunctor2(&testClass,
                                                         &TestClass::member);
    ...
    Functor<void, LOKI_TYPELIST_1(bool &)> member_func(&testClass,
                                                       &TestClass::member);
    ...
    bool compare = functionCompare && functorCompare && classFunctorCompare &&
                   functorCopyCompare && mem_free && free_mem && null0 &&
                   null1 && null2 && null3 && null4
#ifndef LOKI_DISABLE_TYPELIST_MACROS
                   && bindFunctorCompare && chainFunctorCompare;
#else
        ;
#endif
    ...
    r = functionResult && functorResult && classFunctorResult &&
        functorCopyResult && bindFunctorResult && chainFunctorResult && compare;
#else
    // TODO!
    r = functionResult && functorResult && classFunctorResult &&
        functorCopyResult && compare;
#endif
...
private:
  ...
  static void testFunction(bool &result) { result = true; }

  class TestFunctor {
  public:
    void operator()(bool &result) { result = true; }
  ...
  class TestClass {
  public:
    void member(bool &result) { result = true; }
  };
} functorTest;
