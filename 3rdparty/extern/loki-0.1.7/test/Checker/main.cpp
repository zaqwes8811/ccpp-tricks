...
private:
  ...
  // These lines show how to declare checkers for non-static functions in a host
  // class.
  typedef ::Loki::ContractChecker<Thingy, ::Loki::CheckForNoThrow>
      CheckForNoThrow;
  typedef ::Loki::ContractChecker<Thingy, ::Loki::CheckForNoChangeOrThrow>
      CheckForNoChangeOrThrow;
  typedef ::Loki::ContractChecker<Thingy, ::Loki::CheckForNoChange>
      CheckForNoChange;
  typedef ::Loki::ContractChecker<Thingy, ::Loki::CheckForEquality>
      CheckForEquality;
  typedef ::Loki::ContractChecker<Thingy, ::Loki::CheckForNothing>
      CheckInvariants;

  // These lines show how to declare checkers for static functions of a host
  // class.
  typedef ::Loki::StaticChecker<::Loki::CheckStaticForNoThrow>
      CheckStaticForNoThrow;
  typedef ::Loki::StaticChecker<::Loki::CheckStaticForNothing>
...
void Thingy::AddCount(unsigned int count) {
  ...
  CheckInvariants checker(this, &Thingy::IsValid, nullptr,
                          &Thingy::IsValidFull);
...
unsigned int Thingy::GetCount(unsigned int index) const {
  ...
  CheckForNoChangeOrThrow checker(this, &Thingy::IsValid, &Thingy::IsValidFull,
                                  &Thingy::IsValidFull);
...
void Thingy::ClearCounts(void) {
  ...
  CheckForNoThrow checker(this, &Thingy::IsValid, nullptr,
                          &Thingy::IsValidEmpty);
  m_counts.clear();
}
