...
// DANGER: циклическое неудаление при использовании shared_ptr. "Подводные камни" http://habrahabr.ru/post/191018/
// А ведь собственный указатель может быть и без пары shared_ptr/weak_ptr
