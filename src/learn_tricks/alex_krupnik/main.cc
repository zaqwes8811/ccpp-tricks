...
//
// в slt нельзя нарушать предусловия, иначе может происх. что угодно
...
int main() {
  ...
  // с умными указателями для реализации ссыл. сем. возн. проблемы
  
  
  /// DANGER: обработка ошибок и типичные ош. при работе
}