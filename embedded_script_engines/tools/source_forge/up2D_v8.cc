...
//$LastLevelGetters
void RefineInMemoryStorageV8::LLGetterByIdx_currents(
      uint32_t index, 
...
//$LastLevelSetters
void RefineInMemoryStorageV8::LLSetterByIdx_currents(
    uint32_t index,
...
//$ZeroLevelGetters
void RefineInMemoryStorageV8::ZLGetter_currents(
  ...
  Handle<ObjectTemplate> templ = Local<ObjectTemplate>::New(
      ...
      ArrayMakeBlueprint(
          Isolate::GetCurrent(), 
          LLGetterByIdx_currents,
          LLSetterByIdx_currents));
  Handle<Object> instance = templ->NewInstance();
  Handle<External> array_handle = External::New(danger_real_ptr->currents);
